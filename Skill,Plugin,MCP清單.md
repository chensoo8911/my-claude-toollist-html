...
> 盤點日期：2026-08-18　｜　由 toollist skill 自動產生（每次覆蓋＝永遠最新）
...
|---|---|---|---|
| **figma** | 2.2.95 | claude-plugins-official | [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) |
